...
namespace AppwriteTests
{
    public class Tests
    {
        ...
        public async Task Test1Async()
        {
            ...
            Debug.Log(Permission.Read(Role.User(ID.Custom("123"))));
            Debug.Log(Permission.Read(Role.Users()));
            Debug.Log(Permission.Read(Role.Guests()));
            Debug.Log(Permission.Read(Role.Team("123")));
            Debug.Log(Permission.Read(Role.Team("123", "admin")));
            Debug.Log(Permission.Read(Role.Member("123")));
            Debug.Log(Permission.Read(Role.Users("verified")));
            Debug.Log(Permission.Read(Role.Users("unverified")));
            Debug.Log(Permission.Read(Role.Label("admin")));
